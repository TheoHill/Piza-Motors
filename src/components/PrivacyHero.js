    ...
    <section className="relative h-[300px] md:h-[400px] overflow-hidden">
      ...
      <div className="absolute inset-0">
        <Image
          ...
          alt="Privacy Policy - Piza Motors"
          fill
              ...
              <nav className="hidden md:flex space-x-8">
                {[
                  ...
                  <a
                    key={link.name}
                    href={link.href}
                    className="px-3 py-2 text-sm font-medium transition-colors relative group text-gray-800 hover:text-yellow-500"
                  >
                    {link.name}
                    <span className="absolute bottom-0 left-0 h-0.5 bg-yellow-500 transition-all duration-300 w-0 group-hover:w-full"></span>
                  </a>
                ))}
              </nav>
              ...
              <nav className="px-6 py-6 space-y-4">
                {[
                  ...
                  <a
                    key={link.name}
                    href={link.href}
                    className="block py-2 text-sm font-medium transition-colors text-gray-800 hover:text-yellow-500"
                  >
                    {link.name}
                  </a>
                ))}
      ...
      {/* Hero Content */}
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-center items-center text-center h-full">
